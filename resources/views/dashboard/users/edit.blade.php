...
<h1 class="text-2xl font-bold text-gray-800 mb-4">Edit Data Users</h1>
    <form action="{{ route('users.update', $user->id) }}" method="POST" class="w-[90%]" enctype="multipart/form-data">
        @method('put')
        @csrf
