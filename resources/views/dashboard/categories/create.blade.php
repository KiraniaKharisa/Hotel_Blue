...
<h1 class="text-2xl font-bold text-gray-800 mb-4">Create Data Category Rooms</h1>
    <form action="{{ route('categories.store') }}" method="POST" class="w-[90%]">
      ...
      <div class="mb-4">
        ...
        <input type="text" id="class_category" name="class_category" class="w-full outline-none transition duration-300 outline-[1px] mt-2 p-2 border-gray-300 rounded-md shadow-sm focus:outline-blue-500 focus:ouline-blue-500" placeholder="Category class..." value="{{ old('name') }}"/>
